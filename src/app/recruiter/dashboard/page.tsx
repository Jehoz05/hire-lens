...
const mockData = {
  ...
  recentActivity: [
    { action: 'New application received', candidate: 'John Doe', job: 'Frontend Developer', time: '2 hours ago' },
    { action: 'Interview scheduled', candidate: 'Jane Smith', job: 'UX Designer', time: '5 hours ago' },
    { action: 'Job posted', title: 'Senior Backend Engineer', time: '1 day ago' },
    { action: 'Candidate hired', candidate: 'Mike Johnson', job: 'Product Manager', time: '2 days ago' },
  ],
};
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-8">
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {Math.round((job.hires / job.applications) * 100)}% success
                        </div>
                      </div>
                    </div>
                  ))}
        ...
        <TabsContent value="jobs">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">Job management content will go here</p>
            </CardContent>
          </Card>
        </TabsContent>
